...
writeToCSV(account.name, accountGen, account.headers)
writeToCSV(addresses.name, addressesGen, addresses.headers)
writeToCSV(beneficialOwners.name, beneficialOwnersGen, beneficialOwners.headers)
writeToCSV(businessUnit.name, businessUnitGen, businessUnit.headers)
writeToCSV(countriesOfOperation.name, countriesOfOperationGen, countriesOfOperation.headers)
writeToCSV(productOffered.name, productOfferedGen, productOffered.headers)
writeToCSV(document.name, documentGen, document.headers)
writeToCSV(relationship.name, relationshipGen, relationship.headers)
writeToCSV(customerInd.name, customerIndGen, customerInd.headers)
writeToCSV(customerOrg.name, customerOrgGen, customerOrg.headers)